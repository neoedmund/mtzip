...
public class CopyUI {
	...
	public static class MainPanel extends JComponent {
		...
		MainPanel(JFrame frame) {
			...
			lay.commitLine();
			lay.addComponent(new JLabel("copy to:"));
			...
			jtf3.setText("" + cores);
			lay.addComponent(new JLabel("Threads for file writing:"));
		...
		protected void startCopy() {
			jlst.setText("copying file...");
			final Copyer enc = new Copyer();
			new Thread() {
	...
	public void run() {
		JFrame frame = new JFrame("M Copyer "+C.VER);
